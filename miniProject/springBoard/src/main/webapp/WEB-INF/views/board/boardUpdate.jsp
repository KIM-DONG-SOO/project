		...
		$j("#submit").on("click",function(){
			...
			$j.ajax({
			    ...
			    success: function(data, textStatus, jqXHR)
			    {
					...
					// 히든 필드에서  pageNo 값 가져오기
					var pageNo = $j('.boardUpdate input[name="pageNo"]').val();
					var boardType = $j('.boardUpdate input[name="boardType"]').val();
					var boardNum = $j('.boardUpdate input[name="boardNum"]').val();
